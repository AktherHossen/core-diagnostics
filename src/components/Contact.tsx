              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold">HealthCare Diagnostic Center</div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold">info@healthcarediagnostic.com</div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold">Mon - Sat: 7:00 AM - 9:00 PM</div>
                      <div className="text-blue-100">Sunday: 8:00 AM - 6:00 PM</div>
                    </div>
                  </div>
                </div>
              </div>
